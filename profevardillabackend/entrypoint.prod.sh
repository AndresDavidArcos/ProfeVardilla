...
python -m gunicorn profevardilla.wsgi:application --bind 0.0.0.0:443 --timeout 160 --log-level debug --capture-output --preload --access-logfile - --error-logfile - --worker-tmp-dir /dev/shm  
